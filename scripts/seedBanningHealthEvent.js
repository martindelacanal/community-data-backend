...
const SECTION_1_QUESTIONS = [
  ...
  q('consent', 'Do you consent for your registration information to be entered into the Bienestar participant system for record keeping and follow-up?',
    '¿Autorizas que tu información de registro se ingrese al sistema de participantes de Bienestar para archivo y seguimiento?'),
...
const SECTION_3_QUESTIONS = [
  ...
  q('multiple', 'What makes it hardest for you to stay healthy? Check all that apply.',
    ...
    { allow_other: true, options: [
      ...
      ['Food access', 'Acceso a alimentos'], ['Housing instability', 'Inestabilidad de vivienda'],
      ['Stress', 'Estrés'], ['Other', 'Otro', { is_other: 'Y' }]] }),
